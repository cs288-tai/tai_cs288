...
class PdfConverter(BaseConverter):
    ...
    def _call_vlm_for_image_description(self, image_path: Path, context_before: str, context_after: str) -> str:
        ...
        prompt = (
            ...
            "Tasks:\n"
            "1. Write a concise but complete description of what this image shows "
            "(diagram, chart, equation, code, table, etc.) and the key information it conveys.\n"
            "2. Write one Q&A pair (question and answer) that tests understanding of this image.\n\n"
